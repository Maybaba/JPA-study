...
class PurchaseRepositoryTest {
    ...
    void createPurchaseTest() {
        ...
        //영속성 컨텍스트 초기화하면 select문을 볼 수 있다.
        em.flush();
        em.clear();

        //then
        Purchase foundPurchase = purchaseRepository.findById(build.getId()).orElseThrow();
    ...
    void findPurchaseListTest() {
        ...
        Purchase purchase1 = Purchase.builder().user(user1).goods(goods3).build();
...
//    @Test
//    @DisplayName("특정 상품을 구매한 유저의 이름을 확인할 수 있다. ")
//    void () {
//        //given
//
//        //when
