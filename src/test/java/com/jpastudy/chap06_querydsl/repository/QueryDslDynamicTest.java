...
import com.jpastudy.chap06_querydsl.entity.QAlbum;
...
import static com.jpastudy.chap06_querydsl.entity.QAlbum.album;
import static com.jpastudy.chap06_querydsl.entity.QGroup.group;
...
class QueryDslDynamicTest {
    ...
    void dynamicTest1() {
        ...
        Integer minAge = 20; //integer 로 null 체크 가능하게(null 값 허용)
        Integer maxAge = 25;
    ...
    void dynamicTest2() {
        //given
        String sortBy = "idolName"; //나이, 이름, 그룹명, 제목 무슨 순으로 보기 .. ? 등
